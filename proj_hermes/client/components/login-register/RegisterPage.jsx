...
export default function RegisterPage() {
    return (
        <div className='min-w-2e min-h-5f h-screen bg-slate-600 flex justify-center items-center px-10 py-20'>
            <div className='min-w-2e min-h-4h max-w-8h max-h-4/5 bg-zinc-800 text-center flex flex-col justify-center w-full p-8 min-[250px]:h-4/5 min-[400px]:h-3/5'>
                ...
                <Link href='/user_page'>
                    <button className='bg-amber-500 font-dalek m-4 p-2 rounded-lg min-[250px]:w-36'>sign up</button>
                </Link>
